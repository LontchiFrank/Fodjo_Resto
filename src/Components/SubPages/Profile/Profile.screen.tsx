            ...
            <div className="w-full rounded-lg dark:border-gray-700 bg-gray-200">
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="flex flex-col gap-4">
                  <div className="flex  h-36 rounded bg-gray-50 dark:bg-white">
                    <div className="flex p-5 justify-left">
                      ...
                      <p className="text-2xl text-gray-400 dark:text-gray-500">
                        <h2 className="pl-3 font-bold">Tasty Fried Chicken</h2>
                  ...
                  <div className="  h-80 rounded bg-gray-50 dark:bg-white">
                    <p className="text-2xl text-gray-400 dark:text-gray-500">
                  ...
                  <div className="flex items-center justify-center h-56 rounded bg-gray-50 dark:bg-white">
                    <p className="text-2xl text-gray-400 dark:text-gray-500">
                      <svg
                ...
                <div className="col-span-2 flex justify-center h-[76vh] rounded bg-gray-50 dark:bg-white">
