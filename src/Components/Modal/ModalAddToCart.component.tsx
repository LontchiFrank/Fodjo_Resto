...
function ModalAddToCart(props:FillProps) {
  return (
   <div>
    {
        props.show ?  <div
      ...
      >
        ...
        <div className=" w-full lg:max-w-full lg:flex">
          <div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden bg-red-600" title="Mountain">
          </div>
          <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            ...
            <div className="flex items-center">
              <img className="w-10 h-10 rounded-full mr-4" src={set} alt="Avatar of Writer"/>
